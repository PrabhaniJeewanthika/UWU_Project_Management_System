...
import { Bell, CalendarDays, FileText, LayoutDashboard, LayoutList, LogOut, Medal, SquareChartGantt, User } from 'lucide-react';
        ...
        >
            <VStack align="start" className='text-black h-full' gap={0}>
                ...
                <div className='px-2 flex flex-col w-full h-full justify-between'>
                    ...
                    <div className='pb-2'>
                        <SidebarItem data={{ title: 'Logout', icon: <LogOut size={15} /> }} />
                    </div>
                </div>
            </VStack>
        </Box>
