// src/components/pages/ManagerPages/ManagerNoticePage.tsx
import React, { useState } from 'react';
import { Bell, EyeOff, CheckCircle } from 'lucide-react';
import { useDisclosure } from '@chakra-ui/react';
import Button from 'src/components/ui/PublicUI/Button';
...
const initialNotices: Notice[] = [
  {
    ...
    title: 'Test Notice',
    content:
      'Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque quos, consequuntur sequi vel...',
    timeAgo: '1 week ago',
    isNew: true,
  },
  {
    ...
    content:
      'Your project deadline is in 2 days. Please update your progress status.',
    timeAgo: '3 days ago',
    isNew: true,
  },
  {
